...
async def data_factory(app, handler):
    async def parse_data(request):
        if request.method =='POST':
            ...
            elif request.content_type.startswith('application/x-www-form-ulencoded'):
...
async def init(loop):
    # await orm.create_pool(loop=loop, host='127.0.0.1', port=3306, user='root', password='123456789', db='awesome')
